...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('afectacio', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text="Percentatge d'afectació d'aquesta pregunta a una discapacitatEntrar un número amb dos decimals. Sol ser 0.00, 0.25, 0.50 o 1.00.", max_digits=3, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], verbose_name="Percentatge d'afectació")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('percentatge_aportacio', models.DecimalField(decimal_places=1, default=Decimal('0'), help_text="Valor del 0.1 al 1.00 quen ens indica quin percentatge de la puntuació aporta aquesta resposta al resultat final(normalment 1.0 ó 0.5) Si aporta 0 llavors no s'ha d'informar aquí.", max_digits=2, validators=[django.core.validators.MinValueValidator(0.1), django.core.validators.MaxValueValidator(1.0)], verbose_name="Percentatge d'aportació al resultat final")),
