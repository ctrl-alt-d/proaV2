# Generated by Django 4.2 on 2023-05-28 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_ca', models.TextField(help_text='Pregunta en català', max_length='250', verbose_name='Pregunta (cat)')),
                ('text_es', models.TextField(blank=True, help_text='Pregunta en castellà', max_length='250', verbose_name='Pregunta (es)')),
                ('text_en', models.TextField(blank=True, help_text='Pregunta amb anglès', max_length='250', verbose_name='Pregunta (en)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_es', models.TextField(blank=True, help_text='Pregunta en castellà', max_length='250', verbose_name='Pregunta (es)')),
                ('text_en', models.TextField(blank=True, help_text='Pregunta amb anglès', max_length='250', verbose_name='Pregunta (en)')),
                ('help_text_ca', models.TextField(help_text='Text ajuda en català', max_length='250', verbose_name='Text ajuda (cat)')),
                ('help_text_es', models.TextField(blank=True, help_text='Text ajuda en castellà', max_length='250', verbose_name='Text ajuda (es)')),
                ('help_text_en', models.TextField(blank=True, help_text='Text ajuda amb anglès', max_length='250', verbose_name='Text ajuda (en)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agrupaciopreguntes', models.ForeignKey(editable=False, help_text='Pregunta', on_delete=django.db.models.deletion.RESTRICT, to='QandA.agrupaciopreguntes', verbose_name='Pregunta')),
        ...
        migrations.CreateModel(
            name='Resposta',
            fields=[
                ('codi', models.TextField(default=QandA.helpers.modelhelpers.calculacodi, editable=False, help_text='Codi intern', max_length=30, primary_key=True, serialize=False, verbose_name='codi')),
                ('text_ca', models.TextField(help_text='Resposta en català', max_length='250', verbose_name='Resposta (cat)')),
                ('text_es', models.TextField(blank=True, help_text='Resposta en castellà', max_length='250', verbose_name='Resposta (es)')),
                ('text_en', models.TextField(blank=True, help_text='Resposta amb anglès', max_length='250', verbose_name='Resposta (en)')),
